...
exports.testClickLeft = function (driver) {
    ...
    return driver
        ...
        .elementById('will_change').text().should.become("h1:10:4")
        .back().sleep(200)
        .title().should.become("Regression Test")
}
...
exports.testDragRight = function (driver) {
    ...
    return driver
        ...
        .elementById('h1').getAttribute("value").should.become(28)
        .elementById('changed').text().should.become("h1:28:28")
        .elementById('changing').text().should.become("h1:10:28")
        .back().sleep(200)
        .title().should.become("Regression Test")
}
...
exports.testDragLeft = function (driver) {
    ...
    return driver
        ...
        .performTouchAction(move).sleep(200)
        .performTouchAction(release).sleep(200)
        .elementById('h1').getAttribute("value").should.become(3)
        .elementById('changed').text().should.become("h1:3:3")
        .elementById('changing').text().should.become("h1:10:3")
        .back().sleep(200)
        .title().should.become("Regression Test")
}
...
exports.testVDragUp = function (driver) {
    ...
    return driver
        ...
        .performTouchAction(move).sleep(200)
        .performTouchAction(release).sleep(600)
        .elementById('v1').getAttribute("value").should.become(469)
        .elementById('changed').text().should.become("v1:469:469")
        .elementById('changing').text().should.become("v1:200:469")
        .back().sleep(200)
        .title().should.become("Regression Test")
}
...
exports.testVDragDown = function (driver) {
    ...
    return driver
        ...
        .elementById('changed').text().should.become("v1:0:0")
        .elementById('changing').text().should.become("v1:200:0")
        .back().sleep(200)
        .title().should.become("Regression Test")
}
