...
exports.testBasic = function (driver) {
    return driver
        ...
        .elementById('vpage_none').click().sleep(200)
        .title().should.become("VPage None")
        ...
        .elementById('b1').click().sleep(100)
        ...
        .elementById('b3').click().sleep(100)
        ...
        .elementById('b4').click().sleep(100)
