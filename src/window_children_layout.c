...
ret_t window_children_layout_open(void) {
  ...
  widget_child_on(win, "default", EVT_CLICK, on_children_layout_event, "default(r=3,c=3,xm=2,ym=3,s=5)");
  widget_child_on(win, "1row", EVT_CLICK, on_children_layout_event, "default(r=1,c=0,xm=2,ym=3,s=4)");
  widget_child_on(win, "1col", EVT_CLICK, on_children_layout_event, "default(r=0,c=1,xm=2,ym=3,s=4)");
