...
ret_t window_check_button_open(void) {
  ...
  widget_child_on(win, "pencil", EVT_VALUE_CHANGED, on_check_button_changed,
                  win);
  widget_child_on(win, "font_small", EVT_VALUE_CHANGED, on_check_button_changed,
                  win);
  widget_child_on(win, "font_normal", EVT_VALUE_CHANGED,
                  on_check_button_changed, win);
  widget_child_on(win, "font_big", EVT_VALUE_CHANGED, on_check_button_changed,
                  win);

  widget_child_on(win, "disable_change", EVT_VALUE_WILL_CHANGE,
                  on_check_button_will_change_not_all_change, win);
