...
ret_t window_popup_open(void) {
  ...
  widget_child_on(win, "enable_close_by_click_outside", EVT_CLICK, on_enable_close_by_click_outside,
                  win);
  widget_child_on(win, "click_outside_and_timer", EVT_CLICK, on_click_outside_and_timer, win);
