...
ret_t window_button_open(void) {
  ...
  widget_child_on(win, "repeat_button", EVT_LONG_PRESS, on_button_event,
                  "long_press");

  widget_child_on(win, "normal_button", EVT_CLICK, on_button_event, "click");
  widget_child_on(win, "normal_button", EVT_LONG_PRESS, on_button_event,
                  "long_press");

  widget_child_on(win, "long_press", EVT_CLICK, on_button_event, "click");
  widget_child_on(win, "long_press", EVT_LONG_PRESS, on_button_event,
                  "long_press");
